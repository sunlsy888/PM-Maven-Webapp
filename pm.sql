...
INSERT INTO `sys_gl_qx` VALUES ('aaecec6789d14356b00bb47f993a7e84', '4', '1', '0', '0', '0', '0', '0');
...
INSERT INTO `sys_menu` VALUES ('6', '项目管理', '#', '0', '2', 'icon-list-alt', '2');
...
INSERT INTO `sys_role` VALUES ('aaecec6789d14356b00bb47f993a7e84', 'RITU', '192', '4', '192', '0', '0', '192', 'aaecec6789d14356b00bb47f993a7e84');
...
INSERT INTO `sys_user` VALUES ('1', 'admin', '223ce7b851123353479d85757fbbf4e320d1e251', '系统管理员', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2017-09-22 17:16:43', '127.0.0.1', '0', '最高统治者', 'default', 'libiao@ritu.cn', '001', '13928273091');
...
INSERT INTO `sys_user` VALUES ('b825f152368549069be79e1d34184afa', 'san', '23261ad6e4075630ad548f89b54767a71bca046f', '三ww', '', 'aaecec6789d14356b00bb47f993a7e84', '2017-09-21 16:57:35', '127.0.0.1', '0', 'sdfsdgf', 'default', 'sdfsdf@qq.com', 'RT001', '18788888888');
...
INSERT INTO `sys_user_qx` VALUES ('aaecec6789d14356b00bb47f993a7e84', '0', '0', '0', '0', '0', '0', '0', '0');
...
-- ----------------------------
-- Table structure for `tb_databug`
-- ----------------------------
DROP TABLE IF EXISTS `tb_databug`;
CREATE TABLE `tb_databug` (
  `Id` int(6) NOT NULL AUTO_INCREMENT,
  `DId` varchar(150) DEFAULT NULL,
  `Provice` varchar(100) DEFAULT NULL,
  `City` varchar(100) DEFAULT NULL,
  `DLevel` varchar(100) DEFAULT NULL,
  `Submitone` varchar(200) DEFAULT NULL,
  `AddDate` date DEFAULT NULL,
  `Title` varchar(200) DEFAULT NULL,
  `DataVer` varchar(100) DEFAULT NULL,
  `ReplayContent` text,
  `ReplayDate` date DEFAULT NULL,
  `Analyse` text,
  `Type` varchar(100) DEFAULT NULL,
  `FixPlan` date DEFAULT NULL,
  `FixVer` varchar(100) DEFAULT NULL,
  `AnalyseDate` date DEFAULT NULL,
  `AnalyseOne` varchar(100) DEFAULT NULL,
  `ResolveVer` varchar(100) DEFAULT NULL,
  `QA1` text,
  `QA1Date` date DEFAULT NULL,
  `QA2` text,
  `QA2Date` date DEFAULT NULL,
  `ConfirmContent` text,
  `State` varchar(100) DEFAULT NULL,
  `ConfirmOne` varchar(100) DEFAULT NULL,
  `Remark` text,
  `IsVisable` char(10) DEFAULT NULL,
  `IsDelete` char(10) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_databug
-- ----------------------------
...
INSERT INTO `tb_pictures` VALUES ('880a17fc95884f619e50bbadf66b3d1b', '图片', '8bc819175687450eb2872d803fbae623.jpg', '20170921/8bc819175687450eb2872d803fbae623.jpg', '2017-09-21 17:01:01', '1', '图片管理处上传');
...
INSERT INTO `tb_pictures` VALUES ('cfc208c922914695bf859133feacf66b', '图片', '26dbba7917784923bd70c53e06656421.jpg', '20170921/26dbba7917784923bd70c53e06656421.jpg', '2017-09-21 17:01:01', '1', '图片管理处上传');

-- ----------------------------
-- Table structure for `tb_pmplan`
-- ----------------------------
DROP TABLE IF EXISTS `tb_pmplan`;
CREATE TABLE `tb_pmplan` (
  ...
  `DPlanDate` date DEFAULT NULL,
  `EndDate` date DEFAULT NULL,
  `Remark` text,
  `IsVisible` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`plan_Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_pmplan
-- ----------------------------

-- ----------------------------
-- Table structure for `tb_pm_naviinfo`
-- ----------------------------
DROP TABLE IF EXISTS `tb_pm_naviinfo`;
CREATE TABLE `tb_pm_naviinfo` (
  `Id` int(11) NOT NULL,
  `PNo` varchar(20) NOT NULL,
  `PName` varchar(150) NOT NULL,
  `PManager` varchar(150) DEFAULT NULL,
  `PDate` varchar(50) DEFAULT NULL,
  `PState` varchar(50) DEFAULT NULL,
  `PDataVer` varchar(20) DEFAULT NULL,
  `PType` varchar(50) DEFAULT NULL,
  `PLevel` varchar(80) DEFAULT NULL,
  `PCustomer` varchar(300) DEFAULT NULL,
  `SoftCompany` varchar(200) DEFAULT NULL,
  `HardSolution` varchar(200) DEFAULT NULL,
  `ProductType` varchar(200) DEFAULT NULL,
  `ScreenResolution` varchar(200) DEFAULT NULL,
  `Memory` varchar(50) DEFAULT NULL,
  `OperSystem` varchar(200) DEFAULT NULL,
  `Storage` varchar(50) DEFAULT NULL,
  `PortRate` varchar(50) DEFAULT NULL,
  `CPUType` varchar(200) DEFAULT NULL,
  `CompilerEnv` varchar(100) DEFAULT NULL,
  `EquipType` varchar(20) DEFAULT NULL,
  `NaviPath` varchar(50) DEFAULT NULL,
  `BindMode` varchar(30) DEFAULT NULL,
  `ActMode` varchar(20) DEFAULT NULL,
  `CPUFrequency` varchar(20) DEFAULT NULL,
  `PSource` text,
  `PRemark` text,
  `IsVisible` char(10) DEFAULT NULL,
  `IsDelete` char(10) DEFAULT NULL,
  `IsVerify` char(10) DEFAULT NULL,
  PRIMARY KEY (`PNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_pm_naviinfo
-- ----------------------------
...
CREATE TABLE `tb_require` (
  ...
  `PId` varchar(100) NOT NULL,
  `SoftCompany` varchar(100) DEFAULT NULL,
  `State` varchar(255) DEFAULT NULL,
  `Ver` varchar(255) DEFAULT NULL,
  ...
  `Des` text,
  `Priority` varchar(255) DEFAULT NULL,
  `SAuthor` varchar(100) DEFAULT NULL,
  `SDate` date DEFAULT NULL,
  `DState` varchar(100) DEFAULT NULL,
  `DAuthor` varchar(100) DEFAULT NULL,
  `DPlanDate` date DEFAULT NULL,
  `EndDate` date DEFAULT NULL,
  `Remark` text,
  `IsDefer` varchar(200) DEFAULT NULL,
  `IsVisible` varchar(100) DEFAULT NULL,
  `AddDate` date DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `tb_softbug`
-- ----------------------------
DROP TABLE IF EXISTS `tb_softbug`;
CREATE TABLE `tb_softbug` (
  `Id` int(6) NOT NULL AUTO_INCREMENT,
  ...
  `Cause` text,
  `Resolvent` text,
  `TestVer` varchar(100) DEFAULT NULL,
  `TestDate` date DEFAULT NULL,
  `TestOne` varchar(100) DEFAULT NULL,
  `FixPlan` date DEFAULT NULL,
  `DOne` varchar(100) DEFAULT NULL,
  `RegressionTestingDate` date DEFAULT NULL,
  `RegressionTestingVer` varchar(100) DEFAULT NULL,
  `RegressionTestingOne` varchar(100) DEFAULT NULL,
  `State` varchar(100) DEFAULT NULL,
...
-- ----------------------------
-- Records of tb_softbug
-- ----------------------------

-- ----------------------------
-- Table structure for `tb_softticket`
-- ----------------------------
DROP TABLE IF EXISTS `tb_softticket`;
CREATE TABLE `tb_softticket` (
  `Id` int(6) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_softticket
-- ----------------------------
