...
<body>
	<form action="project/save.do" name="projectForm" id="projectForm" method="post">
		<input name="Id" id="Id"  type="hidden"  value="${pd.ID }"/>
		<div id="zhongxin">
		<table>
				
			<tr>
			<td><input type="text" name="PNo" id="PNo" value="${pd.PNo }"   title="项目编号"/></td>
				<td><input type="text" name="PName" id="PName"  placeholder="这里输入项目名称" title="项目名称"/></td>
				 <td>
                   <select class="chzn-select" name="PManager" id="PManager" data-placeholder="请选择项目负责人" style="vertical-align:top;"  >
						...
						<option value="">全部</option>
					 	<c:forEach items="${pmanagerList}" var="user">
							<option value="${user.NAME }" <c:if test="${pd.ROLE_ID==user.ROLE_ID}">selected</c:if>>${user.NAME }</option>
						</c:forEach>  
					  	</select>	
</td> 
			</tr>
			...
			<tr>
			<td><input type="text" name="PCustomer" id="PCustomer"  placeholder="这里输入客户名称" title="客户" /></td>
...
<select class="chzn-select" name="HardSolution" id="HardSolution" data-placeholder="请选择硬件方案" style="vertical-align:top;"  >
			...
			<td><select class="chzn-select" name="ProductType" id="ProductType" data-placeholder="请选择产品类型" style="vertical-align:top;"  >
				...
				<td><select class="chzn-select" name="ScreenResolution" id="ScreenResolution" data-placeholder="请选择屏幕分辨率" style="vertical-align:top;"  >
				 ...
				 <td><input type="text" name="Memory" id="Memory"  placeholder="这里输入可用内存" title="可用内存" /></td> 
			</tr> 
			<tr>
			...
			<td><select class="chzn-select" name="CPUType" id="CPUType" data-placeholder="请选择CPU类型 " style="vertical-align:top;"  >
				...
				<td><select class="chzn-select" name="CompilerEnv" id="CompilerEnv" data-placeholder="请选择编译环境 " style="vertical-align:top;"  >
				 ...
				 <td><input type="text" name="EquipType" id="EquipType"  placeholder="这里输入设备型号" title="设备型号" /></td> 
			</tr>   
			<tr>
			<td><input type="text" name="NaviPath" id="NaviPath"  placeholder="这里输入导航路径" title="路径" /></td>
			...
			<tr>
			<td><input type="text" name="CPUFrequency" id="CPUFrequency"  placeholder="这里输入CPU主频 " title="CPU主频 " /></td>
				<td><input type="text" name="PSource" id="PSource"  placeholder="需求类型"  title="需求类型"/></td>
				 ...
				 <select class="chzn-select" name="ItemType" id="ItemType" data-placeholder="请选择立项类型 " style="vertical-align:top;"  >
						<option value="1"  selected>在研项目</option>
						<option value="0">预研项目</option>
			...
			<tr>
						<td id="nr" colspan="3">
							<textarea name="CONTENT" id="CONTENT" style="display:none" ></textarea>
							 ...
							 <script id="editor" type="text/plain" style="width:90%;height:100px;"></script>
						</td>
					</tr>    
		<!-- 	<tr>
