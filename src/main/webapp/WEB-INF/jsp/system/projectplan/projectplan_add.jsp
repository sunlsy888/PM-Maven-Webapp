...
<body>
	<form action="projectplan/save.do" name="projectForm" id="projectForm" method="post">
		...
		<table>
			...
			<tr>
				...
				<td><select class="chzn-select" name="Priority" id="Priority" data-placeholder="请选择项目等级" style="vertical-align:top;"  >
				 ...
				 <td><input type="text" name="Ver" id="Ver"  placeholder="这里输入版本" title="版本"/>
				...
				<td> <select class="chzn-select" name="Remark" id="Remark" data-placeholder="请选择项目说明" style="vertical-align:top;"  >
						<option value=""></option> 
					 	<c:forEach items="${PLevelList}" var="dictionaries">
							<option value="${dictionaries.NAME }" <c:if test="${pd.NAME==dictionaries.NAME}">selected</c:if>>${dictionaries.NAME }</option>
						</c:forEach>  
					  	</select> </td>
