...
<body>
	<form action="problem/${msg }.do" name="projectForm" id="projectForm" method="post">
		...
		<table>
			...
			<tr>
						<td id="nr" colspan="2">
							<textarea name="CONTENT" id="CONTENT" value="${pd.Content }" style="display:none" ></textarea>
								<input type="hidden" name="TYPE" id="TYPE" value="0"/>
							 <script id="editor" type="text/plain" style="width:95%;height:110px;">${pd.Content }</script>
						</td>
					</tr>    
		<!-- 	<tr>
