  ...
  <div class="row-fluid">
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<c:choose>
			<c:when test="${not empty roleList_z}">
				...
				<td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','up_qx');" class="btn btn-warning btn-mini" title="分配上传权限"><i class="icon-wrench icon-2x icon-only"></i></a></td>
				<td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','down_qx');" class="btn btn-warning btn-mini" title="分配下载权限"><i class="icon-wrench icon-2x icon-only"></i></a></td>
				<td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','verify_qx');" class="btn btn-warning btn-mini" title="分配审核权限"><i class="icon-wrench icon-2x icon-only"></i></a></td>
				<td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','reply_qx');" class="btn btn-warning btn-mini" title="分配回复权限"><i class="icon-wrench icon-2x icon-only"></i></a></td>
				<td style="width:30px;"><a onclick="roleButton('${var.ROLE_ID }','confirm_qx');" class="btn btn-warning btn-mini" title="分配确认权限"><i class="icon-wrench icon-2x icon-only"></i></a></td>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function roleButton(ROLE_ID,msg){
			...
			else if(msg == 'verify_qx'){
				Title = "授权审核权限";
			}else if(msg == 'reply_qx'){
				Title = "授权回复权限";
			}else if(msg == 'confirm_qx'){
				Title = "授权确认权限";
			}
