							...
							<div style="float:left;">
								<table border="0" width="50%">
									...
									<td><jsp:include
												...
												<jsp:param name="strXML" value="${pd.strCurMonth}" />
								...
								<table border="0" width="50%">
									<tr>
										<td><jsp:include
												...
												<jsp:param name="strURL" value="" />
												<jsp:param name="strXML" value="${pd.strState} " />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
												<jsp:param name="debugMode" value="false" />
							...
							<div style="float:left;">
								<table border="0" width="50%">
									...
									<td><jsp:include
												...
												<jsp:param name="strURL" value="" />
												<jsp:param name="strXML" value="${pd.strMonth}" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
												<jsp:param name="debugMode" value="false" />
							...
							<div style="float:right;">
								<table border="0" width="50%">
									...
									<td><jsp:include
												...
												<jsp:param name="chartSWF" value="static/FusionCharts/Line.swf" />
												<jsp:param name="strURL" value="" />
												<jsp:param name="strXML" value="${pd.strYear}" />
												<jsp:param name="chartId" value="myNext" />
												<jsp:param name="chartWidth" value="500" />
												<jsp:param name="chartHeight" value="300" />
												<jsp:param name="debugMode" value="false" />
