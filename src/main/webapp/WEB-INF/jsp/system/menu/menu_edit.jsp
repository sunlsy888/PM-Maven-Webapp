	...
	<body>
		<form action="menu/edit.do" name="menuForm" id="menuForm" method="post">
			...
			<table>
				...
				<select class="input_txt" name="IS_FRONTPAGE" id="IS_FRONTPAGE"  style="vertical-align:top;"  >
							 
						<option value="1"   <c:if test="${pd.IS_FRONTPAGE=='1'}">selected</c:if>>首页显示</option>
						<option value="0"  <c:if test="${pd.IS_FRONTPAGE=='0'}">selected</c:if>>首页不显示</option>  
					  	</select>
                </td>
			</tr>
				<tr>
