...
<body>
	<form action="require/updatepm.do" name="projectForm" id="projectForm" method="post">
		...
		<table> 
			<tr>
				...
				<td><select class="chzn-select" name="State" id="State" data-placeholder="请选择状态" style="vertical-align:top;"  >
				 ...
				 <td>
                   <input class=" date-picker" name="DPlanDate" id="DPlanDate"  value="${pd.DPlanDate}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly"  placeholder="计划日期" title="计划日期"/> 
</td> 
			</tr>
