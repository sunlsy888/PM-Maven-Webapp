...
<body>
	<form action="report/save.do" name="projectForm" id="projectForm" method="post">
		<input name="Id" id="Id"  type="hidden"  value="${pd.Id }"/>
		<div id="zhongxin">
		<table>
				<tr>
		       <td><input type="text" name="PM" id="PM"   value="${pd.PM }"  placeholder="项目负责人 "/></td>
				<td ><input type="text" name="PName" id="PName"  placeholder="这里输入项目名称" title="名称"/></td>
				</tr>
			<tr>
		 
					<td id="nr" colspan="2">
							<textarea name="Requirement" id="Requirement" style="display:none" ></textarea>
								 
							 <script id="editor2" type="text/plain" style="width:95%;height:110px;"></script>
						</td>
			</tr>
			...
			<tr>
						<td id="nr" colspan="2">
							<textarea name="ItemDetails" id="ItemDetails" style="display:none" ></textarea>
