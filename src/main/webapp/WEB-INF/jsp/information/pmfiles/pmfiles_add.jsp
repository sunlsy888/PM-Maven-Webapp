...
<script type="text/javascript">
	...
	function delP(PATH,Id){
		 if(confirm("确定要删除？")){
			var url = "pmfiles/deltp.do?FilePath="+PATH+"&Id="+V_Id+"&guid="+new Date().getTime();
...
<body>
	<form action="pmfiles/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr> 
				<td>
					...
					<c:if test="${pd != null && pd.FilePath != '' && pd.FilePath != null }">
						<a href="<%=basePath%>uploadFiles/pmfiles/${pd.FilePath}" target="_blank">${pd.FileName}</a>
