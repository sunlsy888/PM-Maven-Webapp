package com.lsy.ritu.controller.system.head;
...
import com.lsy.ritu.service.system.appuser.AppuserService;
...
import com.lsy.ritu.util.SmsUtil;
import com.lsy.ritu.util.Tools;
import com.lsy.ritu.util.Watermark;
import com.lsy.ritu.util.mail.SimpleMailSender;
...
public class HeadController extends BaseController {
	...
	public Object sendEmail(){
		...
		if(null != strEMAIL && !"".equals(strEMAIL)){
			String strEM[] = strEMAIL.split(",lsy,");
			if(strEM.length == 4){
				if("yes".endsWith(isAll)){
					try {
						List<PageData> userList = new ArrayList<PageData>();
