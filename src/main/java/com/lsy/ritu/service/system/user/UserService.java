package com.lsy.ritu.service.system.user;
...
public class UserService {
	...
	*用户列表(全部)
	*/
	public List<User> listUserzu(PageData pd)throws Exception{
		return (List<User>) dao.findForList("UserXMapper.listUserzu", pd);
	}
	/*
	*用户列表(全部)
	*/
	public List<User> listUserForRole(PageData pd)throws Exception{
		return (List<User>) dao.findForList("UserXMapper.listUserForRole", pd);
	}
	/*
	*用户列表(供应商用户)
	*/
