package com.lsy.ritu.util.mail;
/**   
 * 简单邮件（不带附件的邮件）发送器   
 */ 
  ...
  */    
    ...
    public boolean sendMail(String title,String content,String type,String tomail) throws Exception{   
    	...
    	//这个类主要是设置邮件   
	     ...
	     mailInfo.setUserName("public@ritu.cn");    
	     mailInfo.setPassword("z@13258584");//您的邮箱密码    
	     mailInfo.setFromAddress("public@ritu.cn");    
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setPassword("z@13258584");//您的邮箱密码    
	     mailInfo.setFromAddress("public@ritu.cn");    
	     mailInfo.setToAddress("libiao@ritu.cn");    
