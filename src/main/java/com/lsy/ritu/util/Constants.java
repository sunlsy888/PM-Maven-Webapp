...
public class Constants {
	...
	public static void main(String[] args) {
		Constants.setPICTURE_SAVE_FILE_PATH("D:/Program Files/apache-tomcat-8.0.46/webapps/lsy/topic/");
		Constants.setPICTURE_VISIT_FILE_PATH("http://192.168.1.100:8080/lsy/topic/");
	}
